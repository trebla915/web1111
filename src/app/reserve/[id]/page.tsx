            ...
            >
              ...
              <div className="space-y-2 h-full flex flex-col justify-between">
                <div className="flex justify-between items-start">
                  <h3 className="text-base font-bold text-white uppercase">{table.number}</h3>
                ...
                <motion.button
                  ...
                  className={`w-full py-2 rounded-md font-medium text-sm border border-white text-white transition-all ${
                    table.reserved ? "bg-gray-700 cursor-not-allowed" : "bg-transparent hover:bg-white hover:text-black"
                  }`}
                >
