...
export async function sendReservationConfirmation(
  ...
  try {
    ...
    const qrBuffer = await generateQRCodeBuffer(data.reservationId);
          ...
          <tr>
            <td style="padding:0 40px 25px;text-align:center;">
              <div style="background-color:#ffffff;display:inline-block;padding:16px;border-radius:12px;">
                <img src="cid:qrcode" alt="Check-in QR Code" width="200" height="200" style="display:block;width:200px;height:200px;" />
              </div>
      ...
      attachments: [
        {
          ...
          // @ts-ignore — Resend supports content_id for inline images
          content_id: 'qrcode',
        },
      ],
      tags: [
