...
async function getAuthenticatedUploadUrl(path) {
    try {
        ...
        const bucket = (0, storage_1.getStorage)().app.options.storageBucket;
        if (!bucket) {
...
async function uploadBase64(file, path) {
    try {
        ...
        const uploadResult = await (0, storage_1.uploadString)(storageRef, base64Data, 'base64', {
...
async function uploadWithFetch(file, path) {
...
const uploadImageToStorage = async (file, path) => {
    ...
    const currentStorage = (0, storage_1.getStorage)();
    ...
    try {
        ...
        try {
            ...
            try {
                ...
                const snapshot = await (0, storage_1.uploadBytes)(storageRef, fileBlob, metadata);
                ...
                downloadURL = await (0, storage_1.getDownloadURL)(snapshot.ref);
            }
