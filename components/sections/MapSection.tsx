  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="w-full max-w-5xl mx-auto border border-cyan-900/50 overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="mt-6">
                <a 
                  ...
                  className="bg-cyan-400 hover:bg-cyan-500 text-black px-6 py-3 inline-block transition-colors font-bold"
                >
                  GET DIRECTIONS
                </a>
              </div>
